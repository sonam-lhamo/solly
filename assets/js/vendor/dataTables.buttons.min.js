...
(function (e) {
        ...
        if (m)
          if (Array.isArray(m)) this._expandButton(a, m, c, d);
            ...
            g &&
              ...
              g.conf.buttons &&
                ((g.collection = e("<" + this.c.dom.collection.tag + "/>")),
                (g.conf._collection = g.collection),
                this._expandButton(g.buttons, g.conf.buttons, !0, d)),
      ...
      var c = [],
        d = function (a, b, c) {
          for (var e, f, h = 0, i = b.length; h < i; h++)
            if ((e = b[h]))
              (f = c !== l ? c + h : h + ""),
                a.push({ node: e.node, name: e.conf.name, idx: f }),
          ...
          if (Array.isArray(a) || a instanceof e) {
            ...
            if (-1 !== a.indexOf(",")) {
              ...
              for (h = i.length; g < h; g++)
                i[g].name === j && c.push({ inst: b, node: i[g].node });
            } else
              e(g)
                .filter(a)
                .each(function () {
  ...
  j.Api.register("buttons()", function (a, b) {
    ...
    var c = this.iterator(
      ...
      function (c) {
        if (c._buttons)
          return o.buttonSelector(o.instanceSelector(a, c._buttons), b);
      },
      !0
    );
    c._groupSelector = a;
  ...
  j.Api.register("buttons().containers()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons)
        for (
          var c = o.instanceSelector(b, c._buttons), d = 0, e = c.length;
          d < e;
          d++
        )
